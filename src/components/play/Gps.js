      ...
      <View style={[styles.view, { top }]}>
        <View style={styles.container}>
          <MapView
            ...
            {showMeasurements ? (
              <Measurements user={position} measurePoint={measurePoint} green={greenPoint} />
            ) : null}
            {measurePoint ? (
              <MapView.Marker
            ...
            {greenPoint ? (
              <MapView.Marker pinColor={colors.green} coordinate={greenPoint} identifier="green">
                <Image
            ...
            <MapView.Marker coordinate={position} identifier="user">
              <Image
